...
// The narration timeline + cue placements are recomputed identically (deterministic `say` measure) so
// the clean audio lands on the exact same events as the existing video. Originals are NOT overwritten.
...
// 4) Mix the CLEAN sound-design master (no narration). Same downstream chain as V4.
const ins = [], filt = [], lab = [];

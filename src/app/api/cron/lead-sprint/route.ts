  ...
  try {
    ...
    return NextResponse.json({
      ...
      counts: {
        ...
        excludedLegacy: snapshot.excludedLegacy,
        excludedLegacyArchived: snapshot.excludedLegacyArchived,
        excludedLegacyDisqualified: snapshot.excludedLegacyDisqualified,
      },

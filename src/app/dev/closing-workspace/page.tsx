...
// retention_failed | retained | eligible_live | paid.
...
function base(over: Partial<ClosingWorkspaceView> = {}): ClosingWorkspaceView {
  return {
    ...
    client: { legalName: "Copper Oak Holdings LLC", businessName: "Copper Oak", signerName: "Dana Rivera", signerEmail: "dana@copperoak.com", verified: false },
    terms: {
...
const STATES: Record<string, ClosingWorkspaceView> = {
  ...
  send_authorized: base({
    ...
    readiness: { ...base().readiness, approvalCurrent: true, sendAuthorizationCurrent: true, nextAction: "Send for signature" },
  }),
  partial: production(base({
    ...
    readiness: { ...base().readiness, approvalCurrent: true, sendAuthorizationCurrent: false, productionFlagsEnabled: true, nextAction: "Awaiting signatures" },
  })),
  completed: production(base({
    ...
    readiness: { ...base().readiness, approvalCurrent: true, productionFlagsEnabled: true, nextAction: "Authorize live payment" },
  })),
  retention_failed: production(base({
    ...
    readiness: { ...base().readiness, approvalCurrent: true, productionFlagsEnabled: true, nextAction: "Retention in progress" },
  })),
  ...
  eligible_live: production(base({
    ...
    readiness: { ...base().readiness, approvalCurrent: true, productionFlagsEnabled: true, nextAction: "Collect deposit" },
  })),
  paid: production(base({
    ...
    readiness: { ...base().readiness, approvalCurrent: true, productionFlagsEnabled: true, nextAction: "—" },
  })),
};
